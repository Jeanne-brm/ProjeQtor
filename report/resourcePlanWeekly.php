...
$nbMonths=1;
if ($periodType=='month' and isset($_REQUEST['includeNextMonth']) and !isset($_REQUEST['includeThreeMonthCOEXYA']) and !isset($_REQUEST['includeSixMonthCOEXYA'])) {

  $nbMonths=2;
  $headerParameters.= i18n("colIncludeNextMonth").'<br/>';

}elseif ($periodType=='month' and isset($_REQUEST['includeThreeMonthCOEXYA']) and !isset($_REQUEST['includeSixMonthCOEXYA'])) {

  $nbMonths=3;
  $headerParameters.= i18n("colIncludeThreeMonthCOEXYA").'<br/>';

}elseif ($periodType=='month' and isset($_REQUEST['includeSixMonthCOEXYA'])) {

  $nbMonths=6;
  $headerParameters.= i18n("colIncludeSixMonthCOEXYA").'<br/>';
