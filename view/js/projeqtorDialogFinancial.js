  ...
  if (dijit.byId("resourceCostIdRole").get('value')) {
    dojo.xhrGet({
      url : '../tool/getSingleData.php?dataType=resourceCostDefault&idRole='
          + dijit.byId("resourceCostIdRole").get('value'),
      handleAs : "text",
      load : function(data) {
...
function activityWorkUnitChangeQuantity() {
  ...
  dojo.xhrGet({
    url : '../tool/getSingleData.php?dataType=workCommand' + '&idWorkUnit='
        + dijit.byId('ActivityWorkCommandWorkUnit').get('value')
        + '&idComplexity='
        + dijit.byId('ActivityWorkCommandComplexity').get('value'),
    handleAs : "text",
    load : function(data) {
      total=data * unit;
...
function workCommandChangeIdComplexity() {
  ...
  dojo.xhrGet({
    url : '../tool/getSingleData.php?dataType=workCommand' + '&idWorkUnit='
        ...
        + dijit.byId('workCommandComplexity').get('value'),
    handleAs : "text",
    load : function(data) {
...
function changeBilledWorkCommand() {
  ...
  dojo.xhrGet({
    url : '../tool/getSingleData.php?dataType=billedWorkCommand'
        + '&idWorkCommand='
        + dijit.byId('billedWorkCommandWorkCommand').get('value'),
    handleAs : "text",
    load : function(data) {
      arrayData=data.split('#!#!#!#!#!#');
