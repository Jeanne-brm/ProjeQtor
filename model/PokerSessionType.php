...
class PokerSessionType extends Type {
  ...
  private static $_databaseCriteria = array('scope'=>'PokerSession');
  private static $_colCaptionTransposition = array('description'=>'pokerSessiongAgenda');
